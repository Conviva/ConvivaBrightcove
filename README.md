...
## Cocoapods Installation
    ...
    pod 'ConvivaBrightcove','4.0.27'

    OR 

    // With Advertising Identifier(IDFA) support
    pod 'ConvivaBrightcove','4.0.26'
...
2.	Download the latest ConvivaBrightcove Module from below path.
     * [Without Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaBrightcove/archive/4.0.27.zip)
      OR
     * [With Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaBrightcove/archive/4.0.26.zip) 
